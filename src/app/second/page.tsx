...
export default function MyForm() {
  ...
  return (
    // <WarpBackground>
    <div className="main items-center justify-center h-screen p-16">
      <div className="heading flex flex-col items-center justify-center">
        {/* <h1 className="text-4xl font-bold text-center">Generate Title Ideas</h1> */}
        <HyperText className="text-center text-3xl lg:text-5xl">
          Generate Capstone Project Ideas
        </HyperText>

        <TextAnimate className="hidden md:block" animation="blurInUp" by="word">
          {
      ...
      <div className="main-container flex-col md:flex-row lg:flex items-center justify-center w-full gap-5 ">
        <div className="first bg-white shadow-xl px-20 py-10 ">
          <Form {...form}>
            <form
        ...
        <div className="second bg-white shadow-xl px-20 py-10 w-full md:w-2/6">
          <BorderBeam />
        </div>
      </div>
    </div>
