...
export async function POST(req: Request) {
  try {
    ...
    if (!data?.body || !data?.categories || !data?.types) {
    ...
    Your task is to craft a unique and innovative project ideas specifically tailored for computer science students for their academic or personal projects. The project should be aligned with the following project types: ${typeList}. 
    ...
    4. Provide a summary explaining the project's objective or significance.
    ...
    Format the response as follows do not add asterisk as it is used for formatting only the title:
    - **Title**: [Project Title]
    ...
    - Summary: A concise sentence summarizing the project's core idea.
